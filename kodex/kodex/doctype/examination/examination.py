    ...
    def total_marks(self):
        return sum(
            frappe.get_list(
                "Question",
                filters=[
                    ["name", "in", [record.question for record in self.questions]]
                ],
                pluck="marks",
            ...
            questions_data.append(
                {
                    ...
                    "mcq_question_choices": [
                        x.option for x in question_data.mcq_question_choices
                    ],
                    "coding_question": {
                        "available_languages": [
                            {
                                "title": frappe.get_cached_value(
                                    "Coding Language", x.language, "title"
                                ),
                                "id": x.language,
                            }
